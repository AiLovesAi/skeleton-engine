...
g++^
 ...
 -DNDEBUG^
 src/*.cpp src/util/*.cpp src/graphics/systems/*.cpp src/graphics/window/*.cpp src/graphics/vulkan/*.cpp src/graphics/game/*.cpp src/game/sides/*.cpp src/game/world/*.cpp src/game/states/*.cpp src/game/components/*.cpp src/input/*.cpp src/audio/*.cpp^
