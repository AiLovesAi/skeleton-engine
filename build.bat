...
g++^
 ...
 -DNDEBUG^
 src/*.cpp src/util/*.cpp src/graphics/*.cpp src/graphics/systems/*.cpp src/game/sides/*.cpp src/game/world/*.cpp src/game/states/*.cpp src/game/components/*.cpp src/game/objects/*.cpp src/input/*.cpp src/sound/*.cpp^
